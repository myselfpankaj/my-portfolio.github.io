  ...
  $.getJSON("./assets/json/projects.json", (function (i) {
    i.forEach((function (i, a) {
      ...
      $("#projectsRow").append(s), s = '<div class="modal fade main-project-modal" id="Project' + a + 'Modal" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-body"><button type="button" class="btn cls-btn" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark"></i></button><div class="row"><div class="col-sm-6 col-lg-5 col-xl-4"><div class="thumb-bx"><img src="./assets/img/projects/' + i.banner + '" alt="Image" class="lazy-load img"></div></div><div class="col-sm-6 col-lg-7 col-xl-8"><div class="details-bx"><h5 class="t">' + i.title + '</h5><h6 class="s">Project Type : ' + i.type + '</h6><h6 class="s">Project Duration : 3 Months</h6><h6 class="s">Team Members : ' + i.team_size + '</h6><h6 class="s">Role : ' + i.role + '</h6><h6 class="s"><a href="' + i.link + '" target="_blank" class="link">' + i.link + ' <i class="fa-solid fa-arrow-up-right-from-square"></i></a></h6></div></div><div class="col-12"><div class="about-bx"><h5 class="t">About Project</h5><p class="d">' + i.desc + '</p></div></div><div class="col-12"><div class="skills-used"><h5 class="t">Technologies and Skills Used</h5><div class="skills-bx">', i.technology.forEach((function (i, a) {
        s += '<a href="' + techArr[i].link + '" target="_blank" class="link hvr-float-shadow"><img src="./assets/img/icon/' + techArr[i].image + '" alt="' + techArr[i].title + ' Icon" class="lazy-load img"><h6 class="sk-t">' + techArr[i].title + "</h6></a>"
        ...
        s += '<a href="./assets/img/screenshots/' + a + '" class="link span-' + getRand(1, 3) + " c-" + getRand(1, 5) + '" data-lightbox="' + i.title + ' Screenshots" data-title="' + i.title + " Screenshots " + (t + 1) + '" style="background-image: url(./assets/img/screenshots/' + a + ')"></a>'
...
function loadSkills() {
  $.getJSON("./assets/json/skills.json", (function (i) {
    i.forEach((function (i, a) {
      var s = '<div class="skill-bx" data-aos="fade-up" title="' + i.title + '"><a href="' + i.link + '" class="link hvr-float-shadow" target="_blank"><div class="skill-pro" role="progressbar" aria-valuenow="' + i.skill + '" aria-valuemin="0" aria-valuemax="100" style="--value:' + i.skill + '"><img src="./assets/img/icon/' + i.img + '" class="lazy-load icon"><div class="stitle">' + i.title + "</div></div></a></div>";
      $("#allSkills").append(s)
    }))
  }))
}
...
function loadServices() {
  $.getJSON("./assets/json/services.json", (function (i) {
    i.forEach((function (i, a) {
      var s = '<div class="swiper-slide"><div data-aos="fade-left" data-aos-delay="' + 400 * a + '" class="sbx" style="--color-code:' + i.color + '"><div class="img-bx"><img src="./assets/img/icon/' + i.icon + '" alt="' + i.title + ' Icon" class="lazy-load img"></div><h5 class="t">' + i.title + '</h5><p class="d">' + i.desc + "</p></div></div>";
      $("#allServicesBox").append(s)
    }))
  }))
}
